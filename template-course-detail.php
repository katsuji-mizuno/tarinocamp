...
<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/js/floating.js"></script>
...
<body id="singleCourse" data-merchandise-id="<?php echo $course_info->merchandise_id; ?>">
  ...
  <main class="contents" <?php if (!isset($course_info)) echo 'style="background:#efefef;"'; ?>>
            ...
            <div id="course_head">
              ...
              <div class="innerSP">
                ...
                <ul class="meta">
                  ...
                  <li class="icon_update">最終更新：<?php echo $course_info->last_updated; ?></li>
                  <li>言語：日本語</li>
                </ul>
              </div>
            </div>
                ...
                <div class="cols">
                  <div class="col">
                    <p class="discount_price publicsans">&yen;<?php
                      if ($course_info->discount_price > 0) {
                        echo number_format($course_info->discount_price);
                      }else{
                        echo number_format($course_info->tuition);
                      }
                    ?></p>
                  </div>
                  <div class="col">
                    <?php if ($course_info->discount_price > 0) : ?>
                      <p class="tuition">&yen;<?php echo number_format($course_info->tuition); ?></p>
                      <p class="percent publicsans"><?php echo $percent; ?>%OFF</p>
                    <?php endif ?>
                  </div>
                </div>
                <div class="btn_wrap">
                ...
                <ul>
                  ...
                  ?>
                      <li>
                        ...
                        <a href="<?php echo home_url() ?>/course/tag/<?php echo $tag->tag_slug; ?>/" class="btn_course"><span><?php echo $tag->name ?></span></a>
                      </li>
                  <?php
                      endforeach;
                    endif;
...
　          　 <div id="movie" class="">
              ...
              <div class="box_blue">
                ...
                <?php if (!empty($course_info->skill)) : ?>
                  <ul class="skills">
                    <?php
              ...
              <div class="text">
                <?php echo nl2br($course_info->description);?>
              </div>
              ...
              <!--div id="voice">
                ...
                <?php
//                 if (isset($course_info->user_voice)) : ?>
                  <ul class="voices">
                    <?php
...
//              endif; ?>
              ...
              <!-- このコースを含む -->
              <div id="pack">
                <h3 class="big_title">このコースに関連する商品</h3>
                <?php if (isset($course_info->pack_list)) : ?>
                  <ul class="packs">
                    ...
                    ?>
                        <a href="<?php echo home_url(); ?>/course/detail/<?php echo $pack->merchandise_id;?>/" >
                          <div class="cols">
                            ...
                            <div class="texts">
                              ...
                              <div class="right_box">
                                <div class="pack_price_box">
                                  <p class="pack_discount_price publicsans">&yen;<?php
                                    if ($pack->discount_price > 0) {
                                      echo number_format($pack->discount_price);
                                    }else{
                                      echo number_format($pack->tuition);
                                    }
                                  ?></p>
                                  <?php if ($pack->discount_price > 0) : ?>
                ...
                <div class="innerSP">
                  ...
                  <?php if (isset($course_info->recommend_list)) : ?>
                    <ul class="recommend" id="slide_recommend">
                      ...
                      ?>
                          <li class="auto">
                            <a href="<?php echo home_url(); ?>/course/detail/<?php echo $recommend->merchandise_id;?>/" >
                              <div class="image thumb">
                                <?php
                              ...
                              <div class="texts">
                                ...
                                <div class="recommend_price_box">
                                  <p class="recommend_discount_price publicsans">&yen;<?php
                                    if ($recommend->discount_price > 0) {
                                      echo number_format($recommend->discount_price);
                                    }else{
                                      echo number_format($recommend->tuition);
                                    }
                                    ?></p>
                                  <?php if ($recommend->discount_price > 0) : ?>
      ...
      <?php else: ?>
        <div id="not_found">
          <div class="inner">
            <h1>404</h1>
            <p class="lead">Not Found.<br class="sp_tab"><span> ー お探しのコースは見つかりませんでした。 ー </span></p>
            <p class="text">
  ...
  <!-- スマホ用固定フッター -->
  <div id="subscription" class="forSP">
    <div class="innerSP">
      <div class="sbsc_wrap">
        <div class="col">
          <div class="sbsc_title"><?php echo $course_info->merchandise_name; ?></div>
          <div class="icon sbsc_time">学習時間の目安：<?php echo $course_info->attendance_time;?></div>
        </div>
        <div class="col">
          <p class="sbsc_discount_price publicsans">&yen;<?php
            if ($course_info->discount_price > 0) {
              echo number_format($course_info->discount_price);
            }else{
              echo number_format($course_info->tuition);
          ...
          ?></p>
          <?php if ($course_info->discount_price > 0) : ?>
            <p class="sbsc_tuition">&yen;<?php echo number_format($course_info->tuition); ?></p>
          <?php endif ?>
        </div>
        <div class="col">
          <a href="<?php echo $course_info->ec_jump_key; ?>" target="_blank" class="btn_course is_red"><span class="notosans">お申し込み</span></a>
        </div>
      </div>
    </div>
  </div>
